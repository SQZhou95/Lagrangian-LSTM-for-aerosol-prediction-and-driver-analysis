"""
Train the final XGBoost model with the hyperparameters selected by
...
# XGBoost_grid_search.py when using a different input dataset.
#   local conditions      : n_estimators=500,  max_depth=3, learning_rate=0.05
#   trajectory averages   : n_estimators=1000, max_depth=3, learning_rate=0.05
# ---------------------------------------------------------------------------
para = {
    'n_estimators':     500,
    'max_depth':        3,
...
scipy.io.savemat('XGBoost_training.mat',
                 {'XGBoost': XGBoost, 'para': para_struct,
                  'index': {k: v + 1 for k, v in index.items()}})  # 1-based for MATLAB
print('\nSaved to XGBoost_training.mat')
